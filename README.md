...
The adopted command package and niayan identity now have [successful packaging CI](https://github.com/minto-dane/niayan/actions/runs/34716711208).
This checks development package deployment, not the unfinished native installed-package controller or an OS release.
